...
def build_image(
    ...
    Args:
        ...
        instance_id (str): Instance ID to use for kprize global state manager
    """
    ...
    if instance_id is not None:
        ...
        instance_ids: list[str] = state.get("instance_ids", default=[])  # type: ignore
    ...
    try:
        ...
        state.set(
            instance_ids,
            InstanceValidationStats(failure_mode=FailureMode.BUILD_IMAGE_FAILURE),
        )
...
def build_container(
    ...
    try:
        ...
        config = get_repo_test_spec(test_spec.repo, test_spec.version)
